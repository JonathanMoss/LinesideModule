...
/**
 * The class PointObjectException is a form of Exception that indicates conditions that a reasonable application might want to catch.
 * <p>
 ...
 */
public class PointObjectException extends Exception{
     ...
     */
    public PointObjectException (String message) {
        super(message);
    }
